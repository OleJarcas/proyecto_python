...
def salida ():
    ...
    fecha = time.asctime()
    f = open("registros.txt", "a")
    f.write("OUT " + fecha + " " + "Encargad@ "+ nombre + " $"+ str(totalturno)+"\n")
    f.close()
    print("Registro salvado")
...
def nuevo_pedido():
    ...
    #calculo del total
    total = (combo_s*mult_s + combo_d * mult_d + combo_t*mult_t + postre * mult_p)
...
while True:
    ...
    print(f'{" ":50}1 - Ingreso de nuevo pedido{" ":10}')
    print(f'{" ":50}2 - Cambio de turno{" ":10}')
    print(f'{" ":50}3 - Apagar sistema{" ":10}\n')
